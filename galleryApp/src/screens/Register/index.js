            ...
            {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isValid, isSubmitting }) => (
              <View style={styles.form_area}>
                <View
                  ...
                  <TextInput value={values.c_name} onChangeText={handleChange("c_name")} onBlur={handleBlur("c_name")} style={styles.form_name_input} placeholder={"Adınız..."}
                ...
                <View
                  ...
                  <TextInput value={values.c_surname} onChangeText={handleChange("c_surname")} onBlur={handleBlur("c_surname")} style={styles.form_surname_input} placeholder={"Soyadınız..."}
                             placeholderTextColor={"#737373"} />
                ...
                <View
                  ...
                  <TextInput value={values.email} onChangeText={handleChange("email")} onBlur={handleBlur("email")}
                             keyboardType={"email-address"} style={styles.form_email_input} placeholder={"E-Mail Adresiniz..."}
                             placeholderTextColor={"#737373"} />
                ...
                <View style={styles.form_password_area}>
                  <TextInput value={values.password} onChangeText={handleChange("password")}
                             onBlur={handleBlur("password")} style={styles.form_password_input} secureTextEntry={isSecure} placeholder={"Şifreniz..."}
                             placeholderTextColor={"#737373"} />
                ...
                <View style={styles.form_password_confirm_area}>
                  <TextInput value={values.password_confirmation} onChangeText={handleChange("password_confirmation")}
                             onBlur={handleBlur("password_confirmation")} style={styles.form_password_confirm_input} secureTextEntry={isConfirmSecure}
                ...
                <TouchableOpacity onPress={handleSubmit} disabled={(!isValid || isSubmitting)}
                  ...
                  <Text style={styles.form_login_button_text}>Kayıt Ol</Text>
                </TouchableOpacity>
              </View>
            )}
          </Formik>
          <TouchableOpacity style={styles.signin_text_area}
