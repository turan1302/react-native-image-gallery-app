...
const styles = StyleSheet.create({
  ...
  form_email_area: { flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderBottomColor: "#000" },
  ...
  form_login_button_text : {color : "black",fontWeight : "bold"},

  error_text : {color : "red"},

  signup_text_area : { marginVertical: 20, alignItems: "center" },
  signup_text : { fontSize: 13, fontWeight: "bold", color: "#000" },
});
