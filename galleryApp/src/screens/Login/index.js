    ...
    return (
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {({ values, touched, errors, handleChange, handleBlur, handleSubmit, isValid, isSubmitting }) => (
              <View style={styles.form_area}>
                ...
                <View style={styles.form_password_area}>
                  <TextInput value={values.password} onChangeText={handleChange('password')} onBlur={handleBlur('password')} style={styles.form_password_input} secureTextEntry={isSecure} placeholder={"Şifreniz..."}
                             placeholderTextColor={"#737373"} />
          ...
          <TouchableOpacity style={styles.signup_text_area}
