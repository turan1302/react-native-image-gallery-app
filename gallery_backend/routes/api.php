...
Route::group(["prefix" => "mobile"], function () {
    ...
    Route::group(['prefix'=>'images','middleware' => 'auth:api_client','as'=>'images.'],function (){
        ...
        Route::post('store',[\App\Http\Controllers\api\mobile\image\indexController::class,'store'])->name('create');
